...
public class SecurityConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/**")  // /** means match any string recursively
                .allowedOriginPatterns("http://localhost:*","https://sslsec.azurewebsites.net:*","http://sslsec.azurewebsites.net:*") //Multiple strings allowed. Wildcard * matches all port numbers.
